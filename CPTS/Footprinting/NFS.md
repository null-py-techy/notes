...
```shell-session
ninjathebox98w1@htb[/htb]$ cat /etc/exports 
...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo nmap 10.129.14.128 -p111,2049 -sV -sC
...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell-session
ninjathebox98w1@htb[/htb]$ showmount -e 10.129.14.128
...
```shell-session
ninjathebox98w1@htb[/htb]$ mkdir target-NFS
ninjathebox98w1@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
ninjathebox98w1@htb[/htb]$ cd target-NFS
...
```shell-session
ninjathebox98w1@htb[/htb]$ ls -l mnt/nfs/
...
```shell-session
ninjathebox98w1@htb[/htb]$ ls -n mnt/nfs/
...
```shell-session
ninjathebox98w1@htb[/htb]$ cd ..
ninjathebox98w1@htb[/htb]$ sudo umount ./target-NFS
```