...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo apt install vsftpd 
```
...
```shell-session
ninjathebox98w1@htb[/htb]$ cat /etc/vsftpd.conf | grep -v "#"
```
...
```shell-session
ninjathebox98w1@htb[/htb]$ cat /etc/ftpusers
...
```shell-session
ninjathebox98w1@htb[/htb]$ ftp 10.129.14.136
...
```shell-session
ninjathebox98w1@htb[/htb]$ ls | grep Notes.txt
...
```shell-session
ninjathebox98w1@htb[/htb]$ wget -m --no-passive ftp://anonymous:anonymous@10.129.14.136
...
```shell-session
ninjathebox98w1@htb[/htb]$ touch testupload.txt
```
...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo nmap --script-updatedb
...
```shell-session
ninjathebox98w1@htb[/htb]$ find / -type f -name ftp* 2>/dev/null | grep scripts
...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo nmap -sV -p21 -sC -A 10.129.14.136
...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo nmap -sV -p21 -sC -A 10.129.14.136 --script-trace
...
```shell-session
ninjathebox98w1@htb[/htb]$ nc -nv 10.129.14.136 21
```

  FTP

```shell-session
ninjathebox98w1@htb[/htb]$ telnet 10.129.14.136 21
```
...
```shell-session
ninjathebox98w1@htb[/htb]$ openssl s_client -connect 10.129.14.136:21 -starttls ftp
...
Login as anonymous username and blank password.
