...
```shell-session
ninjathebox98w1@htb[/htb]$ nmap -sV -sC 10.129.201.248 -p3389 --script rdp*
...
```shell-session
ninjathebox98w1@htb[/htb]$ nmap -sV -sC 10.129.201.248 -p3389 --packet-trace --disable-arp-ping -n
...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo cpan
...
```shell-session
ninjathebox98w1@htb[/htb]$ git clone https://github.com/CiscoCXSecurity/rdp-sec-check.git && cd rdp-sec-check
ninjathebox98w1@htb[/htb]$ ./rdp-sec-check.pl 10.129.201.248
...
```shell-session
ninjathebox98w1@htb[/htb]$ xfreerdp /u:cry0l1t3 /p:"P455w0rd!" /v:10.129.201.248
...
```shell-session
ninjathebox98w1@htb[/htb]$ nmap -sV -sC 10.129.201.248 -p5985,5986 --disable-arp-ping -n
...
```shell-session
ninjathebox98w1@htb[/htb]$ evil-winrm -i 10.129.201.248 -u Cry0l1t3 -p P455w0rD!
...
```shell-session
ninjathebox98w1@htb[/htb]$ /usr/share/doc/python3-impacket/examples/wmiexec.py Cry0l1t3:"P455w0rD!"@10.129.201.248 "hostname"
