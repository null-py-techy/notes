...
```shell-session
ninjathebox98w1@htb[/htb]$ cat /etc/snmp/snmpd.conf | grep -v "#" | sed -r '/^\s*$/d'
...
```shell-session
ninjathebox98w1@htb[/htb]$ snmpwalk -v2c -c public 10.129.14.128
...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo apt install onesixtyone
ninjathebox98w1@htb[/htb]$ onesixtyone -c /opt/useful/seclists/Discovery/SNMP/snmp.txt 10.129.14.128
...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo apt install braa
ninjathebox98w1@htb[/htb]$ braa <community string>@<IP>:.1.3.6.*   # Syntax
ninjathebox98w1@htb[/htb]$ braa public@10.129.14.128:.1.3.6.*
