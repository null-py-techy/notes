...
```shell-session
ninjathebox98w1@htb[/htb]$ cat /etc/ssh/sshd_config  | grep -v "#" | sed -r '/^\s*$/d'
...
```shell-session
ninjathebox98w1@htb[/htb]$ git clone https://github.com/jtesta/ssh-audit.git && cd ssh-audit
ninjathebox98w1@htb[/htb]$ ./ssh-audit.py 10.129.14.132
...
```shell-session
ninjathebox98w1@htb[/htb]$ ssh -v cry0l1t3@10.129.14.132
...
```shell-session
ninjathebox98w1@htb[/htb]$ ssh -v cry0l1t3@10.129.14.132 -o PreferredAuthentications=password
...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo nmap -sV -p 873 127.0.0.1
...
```shell-session
ninjathebox98w1@htb[/htb]$ nc -nv 127.0.0.1 873
...
```shell-session
ninjathebox98w1@htb[/htb]$ rsync -av --list-only rsync://127.0.0.1/dev
...
```shell-session
ninjathebox98w1@htb[/htb]$ cat /etc/hosts.equiv
...
```shell-session
ninjathebox98w1@htb[/htb]$ sudo nmap -sV -p 512,513,514 10.0.17.2
...
```shell-session
ninjathebox98w1@htb[/htb]$ cat .rhosts
...
```shell-session
ninjathebox98w1@htb[/htb]$ rlogin 10.0.17.2 -l htb-student
...
```shell-session
ninjathebox98w1@htb[/htb]$ rusers -al 10.0.17.5
