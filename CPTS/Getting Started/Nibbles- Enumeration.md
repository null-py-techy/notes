![](Pasted%20image%2020250920170554.png)
[https://www.youtube.com/watch?v=s_0GcRGv6Ds](https://www.youtube.com/watch?v=s_0GcRGv6Ds)
...
```shell-session
ninjathebox98w1@htb[/htb]$ nmap -v -oG -
...
```shell-session
ninjathebox98w1@htb[/htb]$ nmap -sV --open -oA nibbles_initial_scan 10.129.42.190
...
```shell-session
ninjathebox98w1@htb[/htb]$ nc -nv 10.129.42.190 22
...
```shell-session
ninjathebox98w1@htb[/htb]$ nc -nv 10.129.42.190 80
...
```shell-session
ninjathebox98w1@htb[/htb]$ nmap -sC -p 22,80 -oA nibbles_script_scan 10.129.42.190
...
```shell-session
ninjathebox98w1@htb[/htb]$ nmap -sV --script=http-enum -oA nibbles_nmap_http_enum 10.129.42.190 
...
![](Pasted%20image%2020250920170914.png)