...
```shell-session
ninjathebox98w1@htb[/htb]$ whatweb 10.129.42.190
...
```shell-session
ninjathebox98w1@htb[/htb]$ curl http://10.129.42.190
...
```shell-session
ninjathebox98w1@htb[/htb]$ whatweb http://10.129.42.190/nibbleblog
...
```shell-session
ninjathebox98w1@htb[/htb]$ gobuster dir -u http://10.129.42.190/nibbleblog/ --wordlist /usr/share/seclists/Discovery/Web-Content/common.txt
...
```shell-session
ninjathebox98w1@htb[/htb]$ curl http://10.129.42.190/nibbleblog/README
...
```shell-session
ninjathebox98w1@htb[/htb]$ curl -s http://10.129.42.190/nibbleblog/content/private/users.xml | xmllint  --format -
...
```shell-session
ninjathebox98w1@htb[/htb]$ gobuster dir -u http://10.129.42.190/ --wordlist /usr/share/seclists/Discovery/Web-Content/common.txt
...
```shell-session
ninjathebox98w1@htb[/htb]$ curl -s http://10.129.42.190/nibbleblog/content/private/config.xml | xmllint --format -
